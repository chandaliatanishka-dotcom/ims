    ...
    <div className="page landing">
      ...
      <section className="text-center px-6 py-24 max-w-3xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <a href="/login">
            <button className="px-8 py-3 rounded-xl font-semibold text-sm border-2 border-slate-200 text-slate-700 hover:bg-slate-50 transition">
              Login
            </button>
          </a>
        </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-6xl mx-auto">
            {[
              ...
              <div key={title} className="feature-card p-6 rounded-2xl bg-white border border-slate-200 hover:shadow-lg transition">
        ...
        <div className="container mx-auto px-4 max-w-3xl">
          ...
          <div className="space-y-4">
            {[
              ...
              <div key={step} className="flex gap-5 items-start p-5 rounded-2xl border border-slate-200 bg-white">
